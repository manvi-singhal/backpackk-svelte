<script context="module">export const ctx = 'Grid';
</script>
...
import { Box } from '../Box';
export let use = [], element = undefined, className = '', override = {}, align = 'stretch', cols = 12, grow = false, spacing = 'md', justify = 'flex-start';
