...
export let use = [], element = undefined, className = '', override = {}, label = undefined, opened = null, openDelay = 0, closeDelay = 0, color = 'gray', radius = 'sm', disabled = false, arrowSize = 2, width = 'auto', wrapLines = false, allowPointerEvents = false, tooltipRef = null, tooltipId = null, 
/** --------PopperProps--------------------------------------- */
