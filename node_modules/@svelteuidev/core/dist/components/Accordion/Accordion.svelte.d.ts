...
import type { AccordionEvents as $$AccordionEvents, AccordionValue } from './Accordion';
...
export type AccordionProps<Multiple extends boolean = false> = ReturnType<__sveltets_Render<Multiple>['props']>;
export type AccordionEvents<Multiple extends boolean = false> = ReturnType<__sveltets_Render<Multiple>['events']>;
export type AccordionSlots<Multiple extends boolean = false> = ReturnType<__sveltets_Render<Multiple>['slots']>;
/**
 ...
 * ```
 */
export default class Accordion<Multiple extends boolean = false> extends SvelteComponentTyped<AccordionProps<Multiple>, AccordionEvents<Multiple>, AccordionSlots<Multiple>> {
}
export {};
