<script>import Error from '../../internal/errors/Error.svelte';
import Box from '../Box/Box.svelte';
import Text from '../Text/Text.svelte';
import useStyles from './Divider.styles';
import { DividerErrors } from './Divider.errors';
export let use = [], element = undefined, className = '', override = {}, color = 'gray', orientation = 'horizontal', size = 'xs', label = null, labelPosition = 'left', labelProps = null, variant = 'solid';
