<script context="module">export const ctx = 'Timeline';
</script>
...
export let use = [], element = undefined, className = '', override = {}, active = -1, align = 'left', bulletSize = 20, radius = 'xl', color = 'blue', lineWidth = 4, reverseActive = false;
