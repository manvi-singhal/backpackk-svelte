...
declare module '$env/static/private' {
	...
	export const ANSYS241_DIR: string;
	export const ANSYSLIC_DIR: string;
	export const ANSYSLMD_LICENSE_FILE: string;
	export const APPDATA: string;
	export const AWP_ROOT241: string;
	export const CADOE_LIBDIR241: string;
	...
	export const EFC_11884: string;
	export const EnableLog: string;
	export const GIT_ASKPASS: string;
	export const HOME: string;
	export const HOMEDRIVE: string;
	export const HOMEPATH: string;
	export const ICEMCFD_SYSDIR: string;
	...
	export const SoS_debug_exe: string;
	export const SoS_exe: string;
	export const SoS_install_dir: string;
	export const SPACECLAIM_MODE: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		ANSYS241_DIR: string;
		ANSYSLIC_DIR: string;
		ANSYSLMD_LICENSE_FILE: string;
		APPDATA: string;
		AWP_ROOT241: string;
		CADOE_LIBDIR241: string;
		...
		SESSIONNAME: string;
		SoS_debug_exe: string;
		SoS_exe: string;
		SoS_install_dir: string;
		SPACECLAIM_MODE: string;
		SystemDrive: string;
		SystemRoot: string;
		TEMP: string;
		TERM_PROGRAM: string;
